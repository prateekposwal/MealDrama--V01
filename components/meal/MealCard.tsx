        ...
        >
            ...
            {isLocked && editable !== false && (
                <div className="absolute inset-0 z-20 rounded-[28px] bg-gray-900/50 flex flex-col items-center justify-center pointer-events-none">
                    <div className="bg-gray-800 px-3 py-1.5 rounded-full flex items-center gap-1.5">
                        ...
                        <span className="text-xs font-bold text-gray-300 uppercase tracking-widest">Too late!</span>
                    </div>
                </div>
            )}
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 mb-1">
                    {!hideSlotLabel && (
                        <span className="text-xs font-black uppercase tracking-widest text-gray-500">{slot}</span>
                    )}
                    {!hideTime && (
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                        ...
                        {(() => {
                            ...
                            const primary = [item.roti, item.rice].filter(Boolean).map(s => (s as string).toLowerCase().trim());
