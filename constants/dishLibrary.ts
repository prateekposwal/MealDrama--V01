...
const allDishes: Dish[] = [
  ...
  { id: 'ulava-charu', name: 'Ulava Charu (Horsegram Soup)', icon: '🥣', region: 'all', states: ['Andhra Pradesh', 'Telangana'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['protein', 'iron'], tags: ['soup', 'horsegram', 'andhra', 'healthy', 'traditional'], variants: [{ id: 'uc-classic', name: 'Ulava Charu', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'tomato-saar', name: 'Tomato Saar', icon: '🥣', region: 'all', states: ['Maharashtra', 'Goa', 'Karnataka'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['vitamin-c', 'fiber'], tags: ['soup', 'tomato', 'saar', 'maharashtrian', 'tangy', 'kokan'], variants: [{ id: 'tsaar-classic', name: 'Tomato Saar', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'chana-sattu-soup', name: 'Chana Sattu Soup', icon: '🥣', region: 'all', states: ['Bihar', 'Uttar Pradesh', 'West Bengal'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['protein', 'fiber'], tags: ['soup', 'sattu', 'bihari', 'healthy', 'summer'], variants: [{ id: 'css-classic', name: 'Chana Sattu Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  ...
  { id: 'lemon-coriander-soup', name: 'Lemon Coriander Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'veg', weight: 'light', nutrition: ['vitamin-c'], tags: ['soup', 'lemon', 'coriander', 'indian-chinese', 'light', 'starter'], variants: [{ id: 'lcs-classic', name: 'Lemon Coriander Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'hot-and-sour-soup', name: 'Hot and Sour Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'veg', weight: 'light', nutrition: ['fiber'], tags: ['soup', 'hot-sour', 'indian-chinese', 'spicy', 'tangy'], variants: [{ id: 'hss-classic', name: 'Hot and Sour Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  ...
  { id: 'honey-chilli-potato', name: 'Honey Chilli Potato', icon: '🥔', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks', 'lunch'], type: 'veg', weight: 'medium', nutrition: ['carb'], tags: ['indian-chinese', 'potato', 'honey', 'chilli', 'crispy', 'starter'], variants: [{ id: 'hcp-classic', name: 'Honey Chilli Potato', cookingStyle: 'fried' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'chicken-lollipop', name: 'Chicken Lollipop', icon: '🍗', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks', 'lunch', 'dinner'], type: 'non-veg', weight: 'medium', nutrition: ['protein'], tags: ['indian-chinese', 'chicken', 'lollipop', 'fried', 'spicy', 'starter'], variants: [{ id: 'cl-classic', name: 'Chicken Lollipop', cookingStyle: 'fried' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'spring-rolls', name: 'Spring Rolls', icon: '🥟', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore', 'Kolkata'], category: ['snacks', 'lunch'], type: 'veg', weight: 'medium', nutrition: ['carb', 'fiber'], tags: ['indian-chinese', 'spring-rolls', 'crispy', 'fried', 'starter'], variants: [{ id: 'sr-classic', name: 'Spring Rolls', cookingStyle: 'fried' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'spiced-masala-oats', name: 'Spiced Masala Oats', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['fiber', 'protein'], tags: ['oats', 'breakfast', 'masala', 'healthy', 'quick'], variants: [{ id: 'smo-classic', name: 'Spiced Masala Oats', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  { id: 'vegetable-oats-upma', name: 'Vegetable Oats Upma', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['fiber', 'protein'], tags: ['oats', 'upma', 'breakfast', 'healthy', 'south-indian'], variants: [{ id: 'vou-classic', name: 'Vegetable Oats Upma', mealContext: 'breakfast' , ingredients: [{ name: 'Semolina', quantity: 1, unit: 'cup', category: 'grains' }, { name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Mustard Seeds', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Onion', quantity: 1, unit: 'pc', category: 'produce' }, { name: 'Green Chili', quantity: 1, unit: 'pc', category: 'produce' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'oats-poha', name: 'Oats Poha', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['fiber', 'carb'], tags: ['oats', 'poha', 'breakfast', 'healthy', 'quick'], variants: [{ id: 'op-classic', name: 'Oats Poha', mealContext: 'breakfast' , ingredients: [{ name: 'Poha', quantity: 1, unit: 'cup', category: 'grains' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Mustard Seeds', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Onion', quantity: 1, unit: 'pc', category: 'produce' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }, { name: 'Lemon Juice', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  { id: 'dahi-tadka-oats', name: 'Dahi Tadka Oats', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['probiotic', 'fiber'], tags: ['oats', 'curd', 'tadka', 'breakfast', 'healthy'], variants: [{ id: 'dto-classic', name: 'Dahi Tadka Oats', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  { id: 'milk-oats-fusion', name: 'Milk Oats (Indian Fusion)', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['fiber', 'protein', 'calcium'], tags: ['oats', 'milk', 'breakfast', 'healthy', 'fusion'], variants: [{ id: 'mof-classic', name: 'Milk Oats', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  ...
  { id: 'lebanese-lentil-soup', name: 'Lebanese Lentil Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['protein', 'fiber'], tags: ['soup', 'lentil', 'lebanese', 'healthy'], variants: [{ id: 'lls-classic', name: 'Lebanese Lentil Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'vegan-tomato-soup', name: 'Vegan Tomato Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['fiber', 'vitamin-c'], tags: ['soup', 'tomato', 'vegan', 'creamy'], variants: [{ id: 'vts-classic', name: 'Vegan Tomato Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'ginger-carrot-coconut-soup', name: 'Ginger Carrot Coconut Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['vitamin-a', 'fiber'], tags: ['soup', 'carrot', 'ginger', 'coconut'], variants: [{ id: 'gccs-classic', name: 'Ginger Carrot Coconut Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'curried-sweet-potato-soup', name: 'Curried Sweet Potato Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['vitamin-a', 'fiber'], tags: ['soup', 'sweet-potato', 'curry', 'creamy'], variants: [{ id: 'csps-classic', name: 'Curried Sweet Potato Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'pumpkin-sweet-potato-soup', name: 'Pumpkin and Sweet Potato Soup', icon: '🎃', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'vegan', weight: 'light', nutrition: ['vitamin-a', 'fiber'], tags: ['soup', 'pumpkin', 'sweet-potato', 'creamy'], variants: [{ id: 'psps-classic', name: 'Pumpkin and Sweet Potato Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'vegetarian-taco-soup', name: 'Vegetarian Taco Soup', icon: '🥣', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch', 'dinner'], type: 'veg', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['soup', 'taco', 'mexican', 'cheesy'], variants: [{ id: 'vtsoup-classic', name: 'Vegetarian Taco Soup', mealContext: 'dinner' , ingredients: [{ name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  ...
  { id: 'healthy-oatmeal-banana-pancakes', name: 'Healthy Oatmeal Banana Pancakes', icon: '🥞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['pancakes', 'oatmeal', 'banana', 'breakfast'], variants: [{ id: 'hobp-classic', name: 'Healthy Oatmeal Banana Pancakes', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  { id: 'vegan-potato-pancakes', name: 'Vegan Potato Pancakes', icon: '🥔', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'vegan', weight: 'medium', nutrition: ['carb'], tags: ['pancakes', 'potato', 'vegan', 'crispy'], variants: [{ id: 'vpp-classic', name: 'Vegan Potato Pancakes', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'classic-pancakes', name: 'Classic Pancakes', icon: '🥞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['pancakes', 'classic', 'breakfast', 'fluffy'], variants: [
  ...
  { id: 'blueberry-banana-oat-bread', name: 'Blueberry Banana Oat Bread', icon: '🍞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['carb', 'fiber'], tags: ['bread', 'banana', 'blueberry', 'oat'], variants: [{ id: 'bbob-classic', name: 'Blueberry Banana Oat Bread', mealContext: 'breakfast' , ingredients: [{ name: 'Flour', quantity: 2, unit: 'cups', category: 'grains' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  { id: 'banana-bread-no-butter', name: 'Banana Bread without Butter', icon: '🍞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'vegan', weight: 'medium', nutrition: ['carb', 'fiber'], tags: ['bread', 'banana', 'vegan', 'healthy'], variants: [{ id: 'bbnb-classic', name: 'Banana Bread without Butter', mealContext: 'breakfast' , ingredients: [{ name: 'Flour', quantity: 2, unit: 'cups', category: 'grains' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  { id: 'banana-bread-no-brown-sugar', name: 'Banana Bread without Brown Sugar', icon: '🍞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['carb', 'fiber'], tags: ['bread', 'banana', 'healthy', 'low-sugar'], variants: [{ id: 'bbnbs-classic', name: 'Banana Bread No Brown Sugar', mealContext: 'breakfast' , ingredients: [{ name: 'Flour', quantity: 2, unit: 'cups', category: 'grains' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  { id: 'banana-peanut-butter-sandwich', name: 'Banana Peanut Butter Sandwich', icon: '🥪', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'vegan', weight: 'light', nutrition: ['protein', 'carb'], tags: ['sandwich', 'banana', 'peanut-butter', 'quick'], variants: [{ id: 'bpbs-classic', name: 'Banana Peanut Butter Sandwich', mealContext: 'breakfast' , ingredients: [{ name: 'Bread', quantity: 4, unit: 'slices', category: 'grains' }, { name: 'Butter', quantity: 1, unit: 'tbsp', category: 'dairy' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  ...
  { id: 'greek-nachos-baked-chickpeas', name: 'Greek Nachos with Baked Chickpeas', icon: '🧀', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['nachos', 'greek', 'chickpeas', 'snack'], variants: [{ id: 'gnbc-classic', name: 'Greek Nachos with Baked Chickpeas', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'lentil-pasta-marinara', name: 'Lentil Pasta with Marinara Sauce', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch'], type: 'veg', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['pasta', 'lentil', 'marinara', 'healthy'], variants: [{ id: 'lpms-classic', name: 'Lentil Pasta with Marinara', mealContext: 'lunch' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'tofu-meatballs', name: 'Tofu Meatballs', icon: '🧆', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'healthy-fats'], tags: ['tofu', 'meatballs', 'vegan', 'walnut'], variants: [{ id: 'tm-classic', name: 'Tofu Meatballs', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'tahini-pasta', name: 'Tahini Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch'], type: 'vegan', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['pasta', 'tahini', 'vegan', 'creamy'], variants: [{ id: 'tpasta-classic', name: 'Tahini Pasta', mealContext: 'lunch' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'crispy-potato-tacos', name: 'Crispy Potato Tacos', icon: '🌮', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['carb'], tags: ['tacos', 'potato', 'crispy', 'mexican'], variants: [{ id: 'cpt-classic', name: 'Crispy Potato Tacos', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'baked-penne-roasted-veg', name: 'Baked Penne with Roasted Vegetables', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['fiber', 'carb'], tags: ['pasta', 'penne', 'roasted-veg', 'baked'], variants: [{ id: 'bprv-classic', name: 'Baked Penne with Roasted Vegetables', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-egg-salad-sandwich', name: 'Vegan Egg Salad Sandwich', icon: '🥪', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch'], type: 'vegan', weight: 'light', nutrition: ['protein'], tags: ['sandwich', 'tofu', 'vegan', 'lunch'], variants: [{ id: 'vess-classic', name: 'Vegan Egg Salad Sandwich', mealContext: 'lunch' , ingredients: [{ name: 'Eggs', quantity: 2, unit: 'pcs', category: 'proteins' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Pepper', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'bbq-jackfruit-burrito-bowl', name: 'BBQ Jackfruit Burrito Bowl', icon: '🌯', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['jackfruit', 'bbq', 'burrito', 'bowl'], variants: [{ id: 'bjbb-classic', name: 'BBQ Jackfruit Burrito Bowl', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'vegan-rasta-pasta', name: 'Vegan Rasta Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['fiber', 'healthy-fats'], tags: ['pasta', 'jamaican', 'coconut', 'jerk'], variants: [{ id: 'vrp-classic', name: 'Vegan Rasta Pasta', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'sweet-potato-breakfast-hash', name: 'Spicy Sweet Potato Breakfast Hash', icon: '🍠', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['fiber', 'vitamin-a'], tags: ['hash', 'sweet-potato', 'black-bean', 'spicy'], variants: [{ id: 'spbh-classic', name: 'Spicy Sweet Potato Breakfast Hash', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'sweet-sesame-noodles-tofu-broccoli', name: 'Sweet Sesame Noodles with Tofu and Broccoli', icon: '🍜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['noodles', 'sesame', 'tofu', 'broccoli'], variants: [{ id: 'ssntb-classic', name: 'Sweet Sesame Noodles', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'mushroom-toast', name: 'Mushroom Toast', icon: '🍞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'light', nutrition: ['protein', 'fiber'], tags: ['toast', 'mushroom', 'tofu-spread', 'garlic'], variants: [{ id: 'mt-classic', name: 'Mushroom Toast', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-chow-mein', name: 'Vegan Chow Mein', icon: '🍜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['fiber', 'carb'], tags: ['chow-mein', 'vegan', 'noodles', 'vegetable'], variants: [{ id: 'vcm-classic', name: 'Vegan Chow Mein', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'veggie-shawarma-tofu', name: 'Veggie Shawarma with Tofu', icon: '🌯', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['shawarma', 'tofu', 'wraps', 'spiced'], variants: [{ id: 'vst-classic', name: 'Veggie Shawarma with Tofu', mealContext: 'dinner' }] },
  ...
  { id: 'tofu-pasta', name: 'Tofu Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['pasta', 'tofu', 'vegetable', 'vegan'], variants: [{ id: 'tpf-classic', name: 'Tofu Pasta', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'keto-pizza-bowl', name: 'Keto Pizza Bowl', icon: '🍕', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'veg', weight: 'light', nutrition: ['fiber', 'protein'], tags: ['pizza', 'keto', 'bowl', 'low-carb'], variants: [{ id: 'kpb-classic', name: 'Keto Pizza Bowl', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'english-muffin-pizzas', name: 'Healthy English Muffin Pizzas', icon: '🧀', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['carb', 'protein'], tags: ['pizza', 'english-muffin', 'snack', 'quick'], variants: [{ id: 'emp-classic', name: 'Healthy English Muffin Pizzas', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-sushi-bowl', name: 'Vegan Sushi Bowl', icon: '🍚', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['sushi', 'bowl', 'vegan', 'rice'], variants: [{ id: 'vsb-classic', name: 'Vegan Sushi Bowl', mealContext: 'dinner' , ingredients: [{ name: 'Rice', quantity: 1, unit: 'cup', category: 'grains' }, { name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Onion', quantity: 1, unit: 'pc', category: 'produce' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Garam Masala', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'sourdough-grilled-cheese', name: 'Sourdough Grilled Cheese Sandwich', icon: '🧀', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['sandwich', 'grilled-cheese', 'sourdough'], variants: [{ id: 'sgcs-classic', name: 'Sourdough Grilled Cheese', mealContext: 'snacks' , ingredients: [{ name: 'Bread', quantity: 4, unit: 'slices', category: 'grains' }, { name: 'Butter', quantity: 1, unit: 'tbsp', category: 'dairy' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }]}] },
  { id: 'high-protein-veggie-burgers', name: 'High Protein Veggie Burgers', icon: '🍔', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['burger', 'veggie', 'black-bean', 'high-protein'], variants: [{ id: 'hpvb-classic', name: 'High Protein Veggie Burgers', mealContext: 'dinner' }] },
  { id: 'loaded-veggie-nachos', name: 'Loaded Veggie Nachos', icon: '🧀', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['fiber', 'protein'], tags: ['nachos', 'loaded', 'cheesy', 'snack'], variants: [{ id: 'lvn-classic', name: 'Loaded Veggie Nachos', mealContext: 'snacks' }] },
  { id: 'twice-baked-potatoes-broccoli-cheese', name: 'Twice Baked Potatoes with Broccoli and Cheese', icon: '🥔', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['potato', 'baked', 'broccoli', 'cheese'], variants: [{ id: 'tpbcc-classic', name: 'Twice Baked Potatoes', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegetarian-fajita-bowl', name: 'Vegetarian Fajita Bowl', icon: '🌯', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'veg', weight: 'medium', nutrition: ['fiber', 'protein'], tags: ['fajita', 'bowl', 'mexican', 'vegetable'], variants: [{ id: 'vfb-classic', name: 'Vegetarian Fajita Bowl', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'garlic-bread-grilled-cheese', name: 'Garlic Bread Grilled Cheese with French Onions', icon: '🧀', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['grilled-cheese', 'garlic-bread', 'french-onion'], variants: [{ id: 'gbgc-classic', name: 'Garlic Bread Grilled Cheese', mealContext: 'snacks' , ingredients: [{ name: 'Flour', quantity: 2, unit: 'cups', category: 'grains' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  ...
  { id: 'veggie-spaghetti-sauce', name: 'Vegetarian Spaghetti Sauce', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'light', nutrition: ['fiber'], tags: ['pasta-sauce', 'marinara', 'veggie', 'italian'], variants: [{ id: 'vss-classic', name: 'Vegetarian Spaghetti Sauce', mealContext: 'dinner' }] },
  { id: 'nut-butter-banana-stackers', name: 'Nut Butter Banana Stackers', icon: '🥜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['protein', 'healthy-fats'], tags: ['snack', 'banana', 'nut-butter', 'quick'], variants: [{ id: 'nbbs-classic', name: 'Nut Butter Banana Stackers', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'honeydew-milk-tea', name: 'Honeydew Milk Tea', icon: '🧋', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['vitamin-c'], tags: ['milk-tea', 'honeydew', 'boba', 'refreshment'], variants: [{ id: 'hmt-classic', name: 'Honeydew Milk Tea', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'wintermelon-milk-tea', name: 'Wintermelon Milk Tea', icon: '🧋', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['fiber'], tags: ['milk-tea', 'wintermelon', 'boba', 'refreshment'], variants: [{ id: 'wmt-classic', name: 'Wintermelon Milk Tea', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'chocolate-milk-tea', name: 'Chocolate Milk Tea', icon: '🧋', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['calcium'], tags: ['milk-tea', 'chocolate', 'boba', 'refreshment'], variants: [{ id: 'cmt-classic', name: 'Chocolate Milk Tea', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'peach-milk', name: 'Peach Milk', icon: '🥛', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['vitamin-c', 'calcium'], tags: ['milk', 'peach', 'vegan', 'drink'], variants: [{ id: 'pm-classic', name: 'Peach Milk', mealContext: 'snacks' ,}] },
  { id: 'coconut-milkshake', name: 'Coconut Milkshake', icon: '🥥', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['healthy-fats', 'calcium'], tags: ['milkshake', 'coconut', 'creamy', 'drink'], variants: [{ id: 'cms-classic', name: 'Coconut Milkshake', mealContext: 'snacks' ,}] },
  { id: 'peanut-butter-cup-milkshake', name: 'Peanut Butter Cup Milkshake', icon: '🥜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'healthy-fats'], tags: ['milkshake', 'peanut-butter', 'chocolate', 'vegan'], variants: [{ id: 'pbcm-classic', name: 'Peanut Butter Cup Milkshake', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'oat-milk-hot-chocolate', name: 'Oat Milk Hot Chocolate', icon: '☕', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['calcium'], tags: ['hot-chocolate', 'oat-milk', 'vegan', 'creamy'], variants: [{ id: 'omhc-classic', name: 'Oat Milk Hot Chocolate', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'masala-oats', name: 'Masala Oats', icon: '🥣', region: 'all', states: ['Maharashtra', 'Delhi', 'Bangalore'], category: ['breakfast'], type: 'vegan', weight: 'light', nutrition: ['fiber', 'protein'], tags: ['oats', 'masala', 'indian', 'savory'], variants: [{ id: 'mo-classic', name: 'Masala Oats', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Onion', quantity: 1, unit: 'pc', category: 'produce' }, { name: 'Tomato', quantity: 2, unit: 'pcs', category: 'produce' }, { name: 'Ginger-Garlic Paste', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Turmeric', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Garam Masala', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Coriander Leaves', quantity: 0.25, unit: 'cup', category: 'produce' }]}] },
  { id: 'cherry-almond-chocolate-cookies', name: 'Cherry Almond Chocolate Chip Oatmeal Cookies', icon: '🍪', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['sweet'], tags: ['cookies', 'cherry', 'almond', 'chocolate'], variants: [{ id: 'cacco-classic', name: 'Cherry Almond Cookies', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'birthday-cake-muffins', name: 'Birthday Cake Muffins', icon: '🧁', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet', 'carb'], tags: ['muffins', 'birthday-cake', 'celebratory'], variants: [{ id: 'bcm-classic', name: 'Birthday Cake Muffins', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'strawberry-blueberry-pie', name: 'Strawberry Blueberry Pie', icon: '🥧', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet', 'fiber'], tags: ['pie', 'strawberry', 'blueberry', 'fruit'], variants: [{ id: 'sbp-classic', name: 'Strawberry Blueberry Pie', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'eggless-brownies', name: 'Eggless Brownies', icon: '🍫', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['brownies', 'eggless', 'fudgy', 'chocolate'], variants: [{ id: 'eb-classic', name: 'Eggless Brownies', mealContext: 'snacks' }] },
  { id: 'strawberry-cheesecake-cookies', name: 'Strawberry Cheesecake Cookies', icon: '🍪', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['cookies', 'strawberry', 'cheesecake', 'soft'], variants: [{ id: 'scc-classic', name: 'Strawberry Cheesecake Cookies', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-lemon-cupcakes', name: 'Vegan Lemon Cupcakes', icon: '🧁', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['cupcakes', 'lemon', 'vegan', 'citrus'], variants: [{ id: 'vlc-classic', name: 'Vegan Lemon Cupcakes', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-pineapple-upside-down-cake', name: 'Vegan Pineapple Upside Down Cake', icon: '🍍', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['cake', 'pineapple', 'upside-down', 'vegan'], variants: [{ id: 'vpudc-classic', name: 'Vegan Pineapple Upside Down Cake', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'vegan-carrot-cake-cupcakes', name: 'Vegan Carrot Cake Cupcakes', icon: '🥕', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet', 'fiber'], tags: ['cupcakes', 'carrot-cake', 'vegan', 'spiced'], variants: [{ id: 'vccc-classic', name: 'Vegan Carrot Cake Cupcakes', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'almond-flour-peanut-butter-cookies', name: 'Almond Flour Peanut Butter Cookies', icon: '🥜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['protein', 'healthy-fats'], tags: ['cookies', 'peanut-butter', 'almond-flour'], variants: [{ id: 'afpbc-classic', name: 'Almond Flour Peanut Butter Cookies', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'chocolate-donuts', name: 'Chocolate Donuts', icon: '🍩', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['donuts', 'chocolate', 'vegan', 'baked'], variants: [{ id: 'cd-classic', name: 'Chocolate Donuts', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'biscoff-donuts', name: 'Biscoff Donuts', icon: '🍩', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['donuts', 'biscoff', 'baked', 'indulgent'], variants: [{ id: 'bd-classic', name: 'Biscoff Donuts', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'strawberry-donuts', name: 'Strawberry Donuts', icon: '🍩', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['donuts', 'strawberry', 'baked', 'fruity'], variants: [{ id: 'sd-classic', name: 'Strawberry Donuts', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'tres-leches-cake-gluten-free', name: 'Healthy Gluten Free Tres Leches Cake', icon: '🍰', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['cake', 'tres-leches', 'gluten-free', 'creamy'], variants: [{ id: 'tlcgf-classic', name: 'Gluten Free Tres Leches Cake', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'flourless-gluten-free-brownies', name: 'Flourless Gluten Free Brownies', icon: '🍫', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['brownies', 'flourless', 'gluten-free', 'fudgy'], variants: [{ id: 'fgfb-classic', name: 'Flourless Gluten Free Brownies', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'vegan-vanilla-pudding', name: 'Vegan Vanilla Pudding', icon: '🍮', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['calcium'], tags: ['pudding', 'vanilla', 'vegan', 'creamy'], variants: [{ id: 'vvp-classic', name: 'Vegan Vanilla Pudding', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'vegan-apple-muffins', name: 'Vegan Apple Muffins', icon: '🧁', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet', 'fiber'], tags: ['muffins', 'apple', 'vegan', 'baked'], variants: [{ id: 'vam-classic', name: 'Vegan Apple Muffins', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'mango-nice-cream', name: 'Mango Nice Cream', icon: '🍦', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['vitamin-c'], tags: ['nice-cream', 'mango', 'vegan', 'frozen-dessert'], variants: [{ id: 'mnc-classic', name: 'Mango Nice Cream', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'banana-pudding-lasagna', name: 'Banana Pudding Lasagna', icon: '🍌', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['dessert', 'banana', 'pudding', 'no-bake'], variants: [{ id: 'bpl-classic', name: 'Banana Pudding Lasagna', mealContext: 'snacks' , ingredients: [{ name: 'Sugar', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Cardamom', quantity: 2, unit: 'pods', category: 'spices' }]}] },
  ...
  // ─── Desserts ─────────────────────────────────────────────
  { id: 'gajar-ka-halwa', name: 'Gajar Ka Halwa', icon: '🥕', region: 'all', states: ['Delhi', 'Punjab', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet', 'vitamin-a'], tags: ['dessert', 'carrot', 'halwa', 'ghee', 'festive'], variants: [{ id: 'gkh-classic', name: 'Gajar Ka Halwa', mealContext: 'snacks' , ingredients: [{ name: 'Sugar', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Cardamom', quantity: 2, unit: 'pods', category: 'spices' }]}] },
  { id: 'moong-dal-halwa', name: 'Moong Dal Halwa', icon: '🟡', region: 'all', states: ['Delhi', 'Punjab', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'heavy', nutrition: ['sweet', 'protein'], tags: ['dessert', 'moong-dal', 'halwa', 'ghee', 'rich'], variants: [{ id: 'mdh-classic', name: 'Moong Dal Halwa', mealContext: 'snacks' , ingredients: [{ name: 'Sugar', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Cardamom', quantity: 2, unit: 'pods', category: 'spices' }]}] },
  // ─── Beverages ────────────────────────────────────────────
...
export const DISH_LIBRARY: Dish[] = [
    ...
    // ─── Milk Beverages ──────────────────────────────────────────────
    { id: 'badam-milk', name: 'Badam Milk', icon: '🥛', region: 'south', states: ['Tamil Nadu', 'Karnataka', 'Andhra Pradesh'], category: ['snacks', 'breakfast'], type: 'veg', weight: 'light', nutrition: ['protein', 'calcium', 'vitamin-e'], tags: ['beverage', 'milk', 'almond', 'sweet', 'traditional', 'veg'], variants: [{ id: 'badam-milk-classic', name: 'Badam Milk', mealContext: 'snacks', ingredients: [{ name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Almonds', quantity: 10, unit: 'pcs', category: 'pantry' }, { name: 'Sugar', quantity: 2, unit: 'tsp', category: 'pantry' }, { name: 'Cardamom', quantity: 1, unit: 'pod', category: 'spices' }, { name: 'Saffron', quantity: 2, unit: 'strands', category: 'spices' }] }] },
    { id: 'rose-milk', name: 'Rose Milk', icon: '🌹', region: 'south', states: ['Tamil Nadu', 'Kerala'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['calcium', 'vitamin-d'], tags: ['beverage', 'milk', 'rose', 'sweet', 'summer', 'veg'], variants: [{ id: 'rose-milk-classic', name: 'Rose Milk', mealContext: 'snacks', ingredients: [{ name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Rose Syrup', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Sugar', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Ice Cubes', quantity: 4, unit: 'pcs', category: 'pantry' }] }] },
    ...
    { id: 'sugandha-milk', name: 'Sugandha Milk', icon: '🥛', region: 'south', states: ['Karnataka', 'Kerala'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['calcium', 'vitamin-d'], tags: ['beverage', 'milk', 'aromatic', 'traditional', 'veg'], variants: [{ id: 'sugandha-milk-classic', name: 'Sugandha Milk', mealContext: 'snacks', ingredients: [{ name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Rose Water', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Sugar', quantity: 2, unit: 'tsp', category: 'pantry' }, { name: 'Cardamom', quantity: 1, unit: 'pod', category: 'spices' }] }] },
    ...
    { id: 'temi-tea', name: 'Temi Tea', icon: '🍵', region: 'northeast', states: ['Sikkim'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'caffeine'], tags: ['beverage', 'tea', 'sikkim', 'organic', 'black-tea', 'veg'], variants: [{ id: 'temi-tea-classic', name: 'Temi Tea', mealContext: 'breakfast', ingredients: [{ name: 'Temi Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Honey', quantity: 1, unit: 'tsp', category: 'pantry' }] }] },
    { id: 'darjeeling-tea', name: 'Darjeeling Tea', icon: '🍵', region: 'northeast', states: ['West Bengal', 'Sikkim'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'caffeine'], tags: ['beverage', 'tea', 'darjeeling', 'premium', 'black-tea', 'veg'], variants: [{ id: 'darjeeling-tea-classic', name: 'Darjeeling Tea', mealContext: 'breakfast', ingredients: [{ name: 'Darjeeling Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Lemon', quantity: 1, unit: 'slice', category: 'produce' }] }] },
    { id: 'balma-green-tea', name: 'Balma Green Tea', icon: '🍵', region: 'northeast', states: ['Assam'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'metabolism'], tags: ['beverage', 'tea', 'green-tea', 'assam', 'healthy', 'veg'], variants: [{ id: 'balma-green-tea-classic', name: 'Balma Green Tea', mealContext: 'breakfast', ingredients: [{ name: 'Green Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Honey', quantity: 1, unit: 'tsp', category: 'pantry' }] }] },
    { id: 'berinag-tea', name: 'Berinag Tea', icon: '🍵', region: 'north', states: ['Uttarakhand'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'caffeine'], tags: ['beverage', 'tea', 'uttarakhand', 'artisanal', 'black-tea', 'veg'], variants: [{ id: 'berinag-tea-classic', name: 'Berinag Tea', mealContext: 'breakfast', ingredients: [{ name: 'Berinag Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Sugar', quantity: 1, unit: 'tsp', category: 'pantry' }] }] },
    { id: 'black-tea', name: 'Black Tea', icon: '🍵', region: 'north', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'caffeine'], tags: ['beverage', 'tea', 'black-tea', 'classic', 'veg'], variants: [{ id: 'black-tea-classic', name: 'Black Tea', mealContext: 'breakfast', ingredients: [{ name: 'Black Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Sugar', quantity: 2, unit: 'tsp', category: 'pantry' }, { name: 'Lemon', quantity: 1, unit: 'slice', category: 'produce' }] }] },
    { id: 'green-tea', name: 'Green Tea', icon: '🍵', region: 'north', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast', 'snacks'], type: 'veg', weight: 'light', nutrition: ['antioxidants', 'metabolism', 'vitamin-c'], tags: ['beverage', 'tea', 'green-tea', 'healthy', 'veg'], variants: [{ id: 'green-tea-classic', name: 'Green Tea', mealContext: 'breakfast', ingredients: [{ name: 'Green Tea Leaves', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Water', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Honey', quantity: 1, unit: 'tsp', category: 'pantry' }] }] },
