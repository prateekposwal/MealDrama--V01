...
const allDishes: Dish[] = [
  ...
  { id: 'banana-bread-no-butter', name: 'Banana Bread without Butter', icon: '🍞', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'vegan', weight: 'medium', nutrition: ['carb', 'fiber'], tags: ['bread', 'banana', 'vegan', 'healthy'], defaultPairings: { sides: ['Butter', 'Jam'] }, variants: [{ id: 'bbnb-classic', name: 'Banana Bread without Butter', mealContext: 'breakfast' , ingredients: [{ name: 'Flour', quantity: 2, unit: 'cups', category: 'grains' }, { name: 'Salt', quantity: 0.5, unit: 'tsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
  ...
  { id: 'lentil-pasta-marinara', name: 'Lentil Pasta with Marinara Sauce', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch'], type: 'veg', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['pasta', 'lentil', 'marinara', 'healthy'], defaultPairings: { sides: [] }, variants: [{ id: 'lpms-classic', name: 'Lentil Pasta with Marinara', mealContext: 'lunch' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'tofu-meatballs', name: 'Tofu Meatballs', icon: '🧆', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'healthy-fats'], tags: ['tofu', 'meatballs', 'vegan', 'walnut'], defaultPairings: { sides: [] }, variants: [{ id: 'tm-classic', name: 'Tofu Meatballs', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'tahini-pasta', name: 'Tahini Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['lunch'], type: 'vegan', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['pasta', 'tahini', 'vegan', 'creamy'], defaultPairings: { sides: [] }, variants: [{ id: 'tpasta-classic', name: 'Tahini Pasta', mealContext: 'lunch' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'vegan-rasta-pasta', name: 'Vegan Rasta Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['fiber', 'healthy-fats'], tags: ['pasta', 'jamaican', 'coconut', 'jerk'], defaultPairings: { sides: [] }, variants: [{ id: 'vrp-classic', name: 'Vegan Rasta Pasta', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'sweet-potato-breakfast-hash', name: 'Spicy Sweet Potato Breakfast Hash', icon: '🍠', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['breakfast'], type: 'veg', weight: 'medium', nutrition: ['fiber', 'vitamin-a'], tags: ['hash', 'sweet-potato', 'black-bean', 'spicy'], defaultPairings: { sides: [] }, variants: [{ id: 'spbh-classic', name: 'Spicy Sweet Potato Breakfast Hash', mealContext: 'breakfast' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'vegan-chow-mein', name: 'Vegan Chow Mein', icon: '🍜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['fiber', 'carb'], tags: ['chow-mein', 'vegan', 'noodles', 'vegetable'], defaultPairings: { sides: [] }, variants: [{ id: 'vcm-classic', name: 'Vegan Chow Mein', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'tofu-pasta', name: 'Tofu Pasta', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'medium', nutrition: ['protein', 'fiber'], tags: ['pasta', 'tofu', 'vegetable', 'vegan'], defaultPairings: { sides: [] }, variants: [{ id: 'tpf-classic', name: 'Tofu Pasta', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  { id: 'keto-pizza-bowl', name: 'Keto Pizza Bowl', icon: '🍕', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'veg', weight: 'light', nutrition: ['fiber', 'protein'], tags: ['pizza', 'keto', 'bowl', 'low-carb'], defaultPairings: { sides: [] }, variants: [{ id: 'kpb-classic', name: 'Keto Pizza Bowl', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'twice-baked-potatoes-broccoli-cheese', name: 'Twice Baked Potatoes with Broccoli and Cheese', icon: '🥔', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'veg', weight: 'medium', nutrition: ['carb', 'protein'], tags: ['potato', 'baked', 'broccoli', 'cheese'], defaultPairings: { sides: [] }, variants: [{ id: 'tpbcc-classic', name: 'Twice Baked Potatoes', mealContext: 'dinner' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
  ...
  { id: 'veggie-spaghetti-sauce', name: 'Vegetarian Spaghetti Sauce', icon: '🍝', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['dinner'], type: 'vegan', weight: 'light', nutrition: ['fiber'], tags: ['pasta-sauce', 'marinara', 'veggie', 'italian'], defaultPairings: { sides: [] }, variants: [{ id: 'vss-classic', name: 'Vegetarian Spaghetti Sauce', mealContext: 'dinner' }] },
  { id: 'nut-butter-banana-stackers', name: 'Nut Butter Banana Stackers', icon: '🥜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'light', nutrition: ['protein', 'healthy-fats'], tags: ['snack', 'banana', 'nut-butter', 'quick'], defaultPairings: { sides: [] }, variants: [{ id: 'nbbs-classic', name: 'Nut Butter Banana Stackers', mealContext: 'snacks' , ingredients: [{ name: 'Oil', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Salt', quantity: 1, unit: 'tsp', category: 'pantry' }, { name: 'Red Chili Powder', quantity: 0.5, unit: 'tsp', category: 'spices' }, { name: 'Turmeric', quantity: 0.25, unit: 'tsp', category: 'spices' }]}] },
