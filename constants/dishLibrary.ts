...
const northeastDishes: Dish[] = [
    ...
    },
    {
        ...
        variants: [
            { id: 'kkr-tomato-chutney', name: 'Kodo Ko Roti + Tomato Chutney', addOn: 'with tomato chutney', mealContext: 'breakfast' },
            { id: 'kkr-achar', name: 'Kodo Ko Roti + Achar', addOn: 'with pickle', mealContext: 'lunch' },
        ],
    },
    {
        id: 'masauyra-curry',
