...
const southDishes: Dish[] = [
    ...
    },
    {
        ...
        variants: [
            ...
            { id: 'sambhar-rice-papad', name: 'Sambar Rice + Papad', addOn: 'with papad', mealContext: 'lunch',
              ingredients: [
                { name: 'Rice', quantity: 1, unit: 'cup', category: 'grains' },
                { name: 'Toor Dal', quantity: 0.5, unit: 'cup', category: 'proteins' },
                { name: 'Drumstick', quantity: 1, unit: 'pc', category: 'produce' },
...
const allDishes: Dish[] = [
  ...
  { id: 'vegan-mug-cake', name: 'Vegan Mug Cake', icon: '🍰', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'light', nutrition: ['sweet'], tags: ['mug-cake', 'vegan', 'chocolate', 'quick'], variants: [{ id: 'vmc-classic', name: 'Vegan Mug Cake', mealContext: 'snacks' , ingredients: [{ name: 'Jackfruit', quantity: 1, unit: 'can', category: 'produce' }, { name: 'BBQ Sauce', quantity: 0.25, unit: 'cup', category: 'pantry' }, { name: 'Rice', quantity: 1, unit: 'cup', category: 'grains' }, { name: 'Black Beans', quantity: 0.5, unit: 'cup', category: 'proteins' }, { name: 'Avocado', quantity: 1, unit: 'pc', category: 'produce' }]}] },
   ...
   { id: 'vegan-lemon-cupcakes', name: 'Vegan Lemon Cupcakes', icon: '🧁', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['cupcakes', 'lemon', 'vegan', 'citrus'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'vlc-classic', name: 'Vegan Lemon Cupcakes', mealContext: 'snacks' , ingredients: [{ name: 'Noodles', quantity: 200, unit: 'g', category: 'grains' }, { name: 'Tofu', quantity: 150, unit: 'g', category: 'proteins' }, { name: 'Broccoli', quantity: 1, unit: 'cup', category: 'produce' }, { name: 'Sesame Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Soy Sauce', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Sesame Seeds', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
   { id: 'vegan-pineapple-upside-down-cake', name: 'Vegan Pineapple Upside Down Cake', icon: '🍍', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['cake', 'pineapple', 'upside-down', 'vegan'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'vpudc-classic', name: 'Vegan Pineapple Upside Down Cake', mealContext: 'snacks' , ingredients: [{ name: 'Mushrooms', quantity: 1, unit: 'cup', category: 'produce' }, { name: 'Bread', quantity: 2, unit: 'slices', category: 'grains' }, { name: 'Garlic', quantity: 1, unit: 'clove', category: 'produce' }, { name: 'Butter', quantity: 1, unit: 'tbsp', category: 'dairy' }, { name: 'Thyme', quantity: 0.5, unit: 'tsp', category: 'spices' }]}] },
   { id: 'vegan-carrot-cake-cupcakes', name: 'Vegan Carrot Cake Cupcakes', icon: '🥕', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet', 'fiber'], tags: ['cupcakes', 'carrot-cake', 'vegan', 'spiced'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'vccc-classic', name: 'Vegan Carrot Cake Cupcakes', mealContext: 'snacks' , ingredients: [{ name: 'Noodles', quantity: 200, unit: 'g', category: 'grains' }, { name: 'Mixed Vegetables', quantity: 1, unit: 'cup', category: 'produce' }, { name: 'Soy Sauce', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Garlic', quantity: 1, unit: 'clove', category: 'produce' }]}] },
   { id: 'almond-flour-peanut-butter-cookies', name: 'Almond Flour Peanut Butter Cookies', icon: '🥜', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['protein', 'healthy-fats'], tags: ['cookies', 'peanut-butter', 'almond-flour'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'afpbc-classic', name: 'Almond Flour Peanut Butter Cookies', mealContext: 'snacks' , ingredients: [{ name: 'Pasta', quantity: 200, unit: 'g', category: 'grains' }, { name: 'Tofu', quantity: 150, unit: 'g', category: 'proteins' }, { name: 'Tomato Sauce', quantity: 1, unit: 'cup', category: 'pantry' }, { name: 'Garlic', quantity: 2, unit: 'cloves', category: 'produce' }, { name: 'Olive Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }]}] },
   { id: 'chocolate-donuts', name: 'Chocolate Donuts', icon: '🍩', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'medium', nutrition: ['sweet'], tags: ['donuts', 'chocolate', 'vegan', 'baked'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'cd-classic', name: 'Chocolate Donuts', mealContext: 'snacks' , ingredients: [{ name: 'Cauliflower', quantity: 2, unit: 'cup', category: 'produce' }, { name: 'Cheese', quantity: 0.5, unit: 'cup', category: 'dairy' }, { name: 'Tomato Sauce', quantity: 0.25, unit: 'cup', category: 'pantry' }, { name: 'Olive Oil', quantity: 1, unit: 'tbsp', category: 'pantry' }, { name: 'Italian Seasoning', quantity: 1, unit: 'tsp', category: 'spices' }]}] },
   { id: 'biscoff-donuts', name: 'Biscoff Donuts', icon: '🍩', region: 'all', states: ['Delhi', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet'], tags: ['donuts', 'biscoff', 'baked', 'indulgent'], defaultPairings: { sides: [], beverages: [] }, variants: [{ id: 'bd-classic', name: 'Biscoff Donuts', mealContext: 'snacks' , ingredients: [{ name: 'English Muffins', quantity: 2, unit: 'pcs', category: 'grains' }, { name: 'Tomato Sauce', quantity: 0.25, unit: 'cup', category: 'pantry' }, { name: 'Cheese', quantity: 0.5, unit: 'cup', category: 'dairy' }, { name: 'Mixed Vegetables', quantity: 0.5, unit: 'cup', category: 'produce' }]}] },
