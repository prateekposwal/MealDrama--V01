...
const allDishes: Dish[] = [
  ...
  // ─── Desserts ─────────────────────────────────────────────
   { id: 'gajar-ka-halwa', name: 'Gajar Ka Halwa', icon: '🥕', region: 'north', states: ['Delhi', 'Punjab', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'veg', weight: 'medium', nutrition: ['sweet', 'vitamin-a'], tags: ['dessert', 'carrot', 'halwa', 'ghee', 'festive'], defaultPairings: { sides: ['Pistachios', 'Almonds'], beverages: ['Masala Chai'] }, variants: [{ id: 'gkh-classic', name: 'Gajar Ka Halwa', mealContext: 'snacks' , ingredients: [{ name: 'Sugar', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Cardamom', quantity: 2, unit: 'pods', category: 'spices' }]}] },
   { id: 'moong-dal-halwa', name: 'Moong Dal Halwa', icon: '🟡', region: 'north', states: ['Delhi', 'Punjab', 'Mumbai', 'Bangalore'], category: ['snacks'], type: 'vegan', weight: 'heavy', nutrition: ['sweet', 'protein'], tags: ['dessert', 'moong-dal', 'halwa', 'ghee', 'rich'], defaultPairings: { sides: ['Pistachios', 'Almonds'], beverages: ['Masala Chai'] }, variants: [{ id: 'mdh-classic', name: 'Moong Dal Halwa', mealContext: 'snacks' , ingredients: [{ name: 'Sugar', quantity: 2, unit: 'tbsp', category: 'pantry' }, { name: 'Milk', quantity: 1, unit: 'cup', category: 'dairy' }, { name: 'Cardamom', quantity: 2, unit: 'pods', category: 'spices' }]}] },
  // ─── Beverages ────────────────────────────────────────────
